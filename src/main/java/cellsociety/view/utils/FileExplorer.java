...
/**
 * Utility class for managing file selection dialogs in the application.
 *
 * <p>This class provides file choosers for opening and saving XML data files
 * related to simulations. It maintains a consistent file selection interface
 * by remembering the last accessed directory.
 *
 * @author Calvin Chen
...
public class FileExplorer {
  ...
  // NOTE: make ONE chooser since generally accepted behavior is
  // that it remembers where user left it last
  private static final FileChooser FILE_LOAD_CHOOSER = makeChooser("Open Data File");
